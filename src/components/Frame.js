...
export default function Frame(props) {
    ...
    console.log(`
    ${generateCSSDetails('x')}

    ${generateCSSFrameSet(pixelSize, frames1)}
    `);


    return (
        <Wrapper>
            <StyledFrame frames={frames1} />
        </Wrapper>
    );
}
...
${(props) => generateCSSFrameSet(pixelSize, props.frames)}
`;
